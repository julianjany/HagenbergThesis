...
\begin{figure}[h]
    ...
    \begin{tabular}{cc}
		...
		(c) & (d)
    \end{tabular}
    \caption{Eingabe-Bild~(a); Extrahierte "Buchtaben"~(b); Alle "ipsum" markiert~(c) sowie alle "mauris" markiert~(d). (Wie erwartet kommt der Algorithmus hier an seine Grenzen; durch die stark ausgeprägten Serifen werden ganze Worte als einzelne Buchstaben erkannt.)}
    \label{fig:test-10}
\end{figure}
